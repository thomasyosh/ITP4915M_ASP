...
public static class ObjectExtension
{
     ...
     * </summary>
     */
    public static Dictionary<object, object> MapToDto(this object source)
    {
     ...
     * 
     */
    public static List<Dictionary<object, object>> MapToDto<T>(this List<T> source)
    {
        List<Dictionary<object, object>> map = new List<Dictionary<object, object>>();
